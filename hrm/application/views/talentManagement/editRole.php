...
<div class="content-wrapper" style="min-height: 267px;">
    <div class="container">
        <section class="content">
            ...
            <?php
            echo form_open('role/editRole', array(
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Role Modification</h3>
                        </div>
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">  <?php
                                    foreach ($roleDetailsById as $roleSpecific) {
                                        $id = $roleSpecific['id'];
                                        $roleName = $roleSpecific['role_name'];
                                        $description = $roleSpecific['description'];
                                        $quarterlyEarnedLeaves = $roleSpecific['quarterly_earned_leaves'];
                                        $averageWorkingHour = $roleSpecific['average_working_hour_per_day'];
                                        $selectedAverageHourCalculation = $roleSpecific['average_hour_calculation'];
                                    }
                                    $rollText = array(
                                        'name' => 'role',
                                        'id' => 'role',
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    foreach ($holidaysOfRole as $day) {
                                        
                                        $selectedHolidays[] = $day['id'];
                                    }
                                    echo form_multiselect('holidays[]', $days_dropdown, $selectedHolidays, array(
...
//                                        'data-validation' => 'required',
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    $averageWorkingHourText = array(
                                        ...
                                        'class' => 'form-control',
                                        'placeholder' => 'hour',
                                        'value' => date("H", strtotime($averageWorkingHour)),
                                        'data-validation' => 'required',
                                        'data-validation' => 'number',
                                        'data-validation-allowing' => 'float',
                                    );
                                ...
                                <div class="col-sm-2">
                                    <?php
                                    $averageWorkingMinuteText = array(
                                        'name' => 'averageWorkingMinitue',
                                        'id' => 'averageWorkingMinitue',
                                        'class' => 'form-control',
                                        'placeholder' => 'min',
                                        'value' => date("i", strtotime($averageWorkingHour)),
                                        'data-validation' => 'required',
                                    );
                                    echo form_input($averageWorkingMinuteText);
                                    ?>
                                    <span class="text-danger"> <?php echo form_error('averageWorkingMinitue'); ?> </span>
                                </div>
                            </div>
                            <div class="form-group">
                                <?php
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-10">
                                    <?php
                                    echo form_hidden('roleId', $roleId);
                                    $submitButton = array(
                                        'type' => 'submit',
                                        'content' => 'Save',
