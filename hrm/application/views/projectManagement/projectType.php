                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Projects Type</h3>
                        </div>
                        <div class="box-body">
                            <?php
                            echo anchor('project/addProjectType', 'Add New', array(
                                ...
                                <tbody>
                                    ...
                                    foreach ($projectTypes as $type) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php
                                                echo anchor('project/editProjectType/' . $type['id'], '<i class="fa fa-fw fa-edit"></i>');
                                                ?>
                                            </td>
                                        </tr>
                                        <?php
