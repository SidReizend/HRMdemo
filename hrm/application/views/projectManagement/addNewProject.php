...
<div class="content-wrapper" style="min-height: 267px;">
    <div class="container">
        <section class="content">
            <?php
            echo form_open('project/addNewProject', array(
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">  
                                    <?php
                                    echo form_dropdown('project_head', $heads, $selectedType, array(
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <?php
                                    echo form_dropdown('status', $statuses, $selectedType, array(
                                        'class' => 'form-control select2',
                                        'required' => 'required',
                                    ));
                                    ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <?php
                                    echo form_dropdown('allowance', $allowance, $selectedAllowance, array(
                                        'class' => 'form-control select2',
                                        'required' => 'required',
                                    ));
                                    ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">  <?php
                                    $estimatedHoursText = array(
                                        ...
                                        'id' => 'estimatedHours',
                                        'class' => 'form-control',
                                        'value' => set_value('estimatedHours'),
                                    );
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                <div class="col-sm-10">   <?php
                                    echo form_dropdown('stable_talents[]', $talents, '', array(
                                        'class' => 'form-control select2',
                                        'multiple' => true,
                                        'id' => 'stable_talents'
                                    ));
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">    
                                    <div class="material-switch pull-left">
                                        <input id="someSwitchOption001" name="sub_project" class="someSwitchOption001"  type="checkbox" value="1"/>
