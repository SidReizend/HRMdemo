...
<div class="content-wrapper" style="min-height: 267px;">
    <div class="container">
        <section class="content">
            ...
            echo form_open('companyPolicyManagement/addNewPolicy', array(
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                <div class="col-sm-10">
                                    <textarea id="compose-textarea" class="form-control" name="policy" style="height: 300px"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
