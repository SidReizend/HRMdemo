...
<div class="content-wrapper" style="min-height: 267px;">
    <div class="container">
        <section class="content">
            <?php
            echo form_open('interactionTrack/addNewInteraction', array(
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                <div class="col-sm-10">   <?php
                                    echo form_dropdown('stable_talents', $talents, $selectedTalent, array(
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                <div class="col-sm-10">   <?php
                                    echo form_dropdown('managers', $managers, $selectedManager, array(
                                        'class' => 'form-control select2',
                                        'id' => 'managers',
                                        'required' => 'required'
                                    ));
