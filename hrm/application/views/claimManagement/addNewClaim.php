                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Claim Addition</h3>
                        </div>
                        <div class="box-body">
                            <div class="form-group">
                                <?php
                                echo form_label('Claim Id', 'claimId', array(
                                ...
                                <div class="col-sm-10">  <?php
                                    $claimText = array(
                                        ...
                                        'id' => 'claimId',
                                        'class' => 'form-control',
                                        'value' => set_value('claimId'),
                                        'required' => 'required',
                                    );

                                    echo form_input($claimText);
                                    ?>
                                    <span class="text-danger"> <?php echo form_error('claimId'); ?> </span>
                                </div>
                            </div>
                            <div class="form-group">
                                <?php
                            ...
                            <div class="form-group">
                                <?php
                                echo form_label('Settlement', 'settlement', array(
                                    'class' => 'col-sm-2 control-label',
                                ));
                                ?>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <?php
                                    echo form_dropdown('category', $categoryDropdown, $selectedCategory, array(
                                        'class' => 'form-control select2',
                                        'id' => 'category',
                                        'required' => 'required',
                                    ));
