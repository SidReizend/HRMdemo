    ...
    <div class="container">
        <section class="content">
            ...
            foreach ($knowledge as $knowledge)
            {
                  ...
                  $note=$knowledge['note'];
                  $assigned_to=$knowledge['assigned_to'];
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10"> <?php
                                    ...
                                    echo form_hidden('old_file', $file_name);
                                     echo form_hidden('old_note', $note);
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                        <?php
                                        echo form_label('Assign Employee', 'assigned_to', array(
                                            'class' => 'col-sm-2 control-label'
                                        ));
                                        ?>
                                        <div class="col-sm-10">
                                            ...
                                            $selectedTalent=$assigned_to;
                                            echo form_dropdown('assigned_to', $talentsDropdown, $selectedTalent, array(
                                                'class' => 'form-control select2',
                                                'id' => 'verified_by'
                                            ));
                                            ?>
                             ...
                             <div class="form-group">
                                <?php
                                echo form_label('Notes', 'previous_note', array(
                                    'class' => 'col-sm-2 control-label'
                                ));
                                ?>
                                <div class="col-sm-10"> <?php
                                    ...
                                    echo form_textarea($previous_note);
                             ...
                             <div class="form-group">
                                <?php
                                echo form_label('Add Comments', 'note', array(
                                    'class' => 'col-sm-2 control-label'
                                ));
                                ?>
                                <div class="col-sm-10"> <?php
