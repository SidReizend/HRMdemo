                            ...
                            <table class="table table-bordered table-hover" id="taxTable">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-sm-5">  <?php
                                            $selfOccupiedChecked = $taxDetails->self_occupied === 'y';
                                            $selfOccupiedRadio = array(
                                                'name' => 'selfOccupied',
                                                'id' => 'y',
                                                'value' => 'y',
                                                'checked' => $selfOccupiedChecked
                                            );
                                            ?> 
                                            <?php
                                            ...
                                            <?php
                                            $selfOccupiedChecked = $taxDetails->self_occupied === 'n';
                                            $selfOccupiedRadio = array(
                                                'name' => 'selfOccupied',
                                                'id' => 'n',
                                                'value' => 'n',
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="subheading">
                                            <?php
                                            echo 'Amount of housing loan interest for the F.Y ' . $taxDetails->fin_year;
                                            ?>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="subheading">
                                            <?php
                                            echo 'Housing Loan Principal Repayment';
                                            ?>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="subheading">
                                            <?php
                                            echo 'Term Deposit With Schedule Bank';
                                            ?>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="subheading">
                                            <?php
                                            echo 'National Saving Scheme/Certificate';
                                            ?>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="subheading">
                                            <?php
                                            echo 'Others, (Please specify if any)';
                                            ?>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr id="newInvestments">
                                    ...
                                    <td>
                                        <div class="subheading">
                                            <?php
                                            echo 'Total Investments (U/S 80C - limited to Rs 1,50,000/-only)';
                                            ?>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="subheading">
                                            <?php
                                            echo '80D- Medical Insurance Premium '
