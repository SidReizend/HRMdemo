    ...
    <body class="hold-transition">
        ...
        <div class="col-sm-12 coro-main">
            ...
            <div class="col-sm-4 left-blue">
                <div class="login-box">
                    <div class="login-logo" style="color:#efefef;"> <a href="../../index2.html"><b style="color:#FFF;"><?php echo $hrmName; ?></a> </div>
                    <!--/.login-logo -->
                    <div class="login-box-body sig-bg">
                        ...
                        <div class="form-group has-feedback">
                            <?php echo form_password($password_confirm_text) ?>
                            <span class="glyphicon glyphicon-user form-control-feedback"></span>
                        </div>
                        <div class="row">
                            <!-- /.col -->
