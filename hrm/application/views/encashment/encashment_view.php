                            ...
                            <table id="table_responsive" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    foreach ($compOffDetails as $compOff) {
                                        ?>
                                        <tr data-toggle="tooltip" title="" data-original-title="<?php echo $compOff['encashment_note']; ?>">
                                            <td>
                                                <?php
                                                echo ++$serialNumber;
                                                ?>
                                            ...
                                            <td>
                                                <?php
                                                if ($compOff['encashment'] == 1) {
                                                    echo 'Approved';
                                                } else if ($compOff['encashment'] == 2) {
                                                    echo 'Declined';
                                                } else {
                                                    echo 'Pending';
                                                }
                                            ...
                                            <td>
                                                <?php
                                                if ($compOff['encashment'] == '0') {
                                                    echo anchor('encashmentCntrl/encashmentApprove/attendanceId/' . $compOff['id'] . $redirect, 'Approve', array(
                                                        'class' => 'btn btn-small btn-primary approve_events'
                                                    ));
                                                    echo '&nbsp';
                                                    echo anchor('encashmentCntrl/encashmentDecline/attendanceId/' . $compOff['id'] . $redirect, 'Decline', array(
...
<script>
    ...
    $("body").on("click", ".cancel_events", function (e) {
        ...
        alertify.prompt("Please add A Note For the Reason", function (e) {
            ...
            if (e) {
                $.ajax({
                    url: base_url + "index.php/encashmentCntrl/savenote",
