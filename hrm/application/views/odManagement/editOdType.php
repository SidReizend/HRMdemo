                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">OD Type Modification</h3>
                        </div>
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">  <?php
                                    foreach ($odTypeDetailsById as $odTypeSpecific) {
                                        $odTypeName = $odTypeSpecific['od_type_name'];
                                    }
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-10">
                                    <?php
                                    echo form_hidden('odTypeId', $odTypeId);
                                    $submitButton = array(
                                        'type' => 'submit',
                                        'content' => 'Save',
