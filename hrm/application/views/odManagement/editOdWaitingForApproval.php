                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <?php
                                    echo form_label($talent_name, 'talent', array(
                            ...
                            <table style="background-color: #ccc !important;" width="100%">
                                <thead style="background-color: #3c8dbc !important;">
                                <th class="od-td-width th-align" align="center" valign="middle">Date</th>
                                <th class="od-td-width th-align" align="center" valign="middle">Hour</th>
                                <th class="od-td-width th-align" align="center" valign="middle">Minutes</th>
                                <th class="od-td-width th-align" align="center" valign="middle">Actual hours spend</th>
                                <th class="od-td-width th-align" align="center" valign="middle">Total od hours approved</th>
                                <th class="od-td-width th-align" align="center" valign="middle">Productive hours</th>
                                <th class="od-td-width th-align" align="center" valign="middle">Timesheet</th>
                                </thead>
                                <tbody>
                                    <?php
                                    foreach ($myOdSpecificByMyOdId as $eachDays) {
                                        ...
                                        //getting the data for actual hours spend, total od hours approved, productive hours
                                        $dayDetails = $this->TalentAttendenceSheet->getDateDetails($odOwner, date('Y-m-d', strtotime($eachDays['date_of_od'])));
                                        $actualHoursSpend = isset($dayDetails->actual_hours_spend) ? $dayDetails->actual_hours_spend : '';
                                        $odHours = isset($dayDetails->od_hours) ? $dayDetails->od_hours : '';
                                        $productiveHours = isset($dayDetails->productive_hrs) ? $dayDetails->productive_hrs : '';
                                        ?>
                                        <tr>
                                            <td class="od-td-width" valign="top" align="center" >
                                                <div class="col-md-4 od_details"
                                                     id="<?php echo $eachDays['date_of_od']; ?>" 
                                                     style="color: <?php echo $color; ?>;border: 0px;"
                                                     data-original-title=""
                                                     data-toggle="tooltip" >
                                                         <?php
                                            ...
                                            <td class="od-td-width" align="center" >
                                                <div class="col-sm-8" style="padding:0px !important;">  <?php
                                                    $hoursText = array(
                                                    ...
                                                    echo form_input($hoursText) . '</br>';
                                                    ?>
                                                </div>
                                                <?php
                                                echo form_label('hr', 'hr', array(
                                                    'class' => 'col-sm-2 control-label'
                                                ));
                                                ?>
                                            </td>
                                            <td class="od-td-width" align="center" >
                                                <div class="col-sm-8" style="padding:0px !important;">  <?php
                                                    ...
                                                    echo form_input($minText) . '</br>';
                                                    ?>
                                                </div>
                                                <?php
                                                echo form_label('min', 'min', array(
                                                    'class' => 'col-sm-2 control-label'
                                                ));
                                                ?>
                                            </td>
                                            <td class="od-td-width" align="center" valign="middle">
                                                <div class="col-sm-10" style="color: <?php echo $color; ?>;">  <?php
                                                    echo $actualHoursSpend;
                                                    ?>
                                                </div>
                                            </td>
                                            <td class="od-td-width" align="center" valign="middle">
                                            ...
                                            <td class="od-td-width" align="center" valign="middle">
                                                <div class="col-sm-10" style="color: <?php echo $color; ?>;">  <?php
                                                    echo $productiveHours;
                                                    ?>
                                                </div>
                                            </td>
                                            <td class="od-td-width" align="center" valign="middle">
                                                <a href="#" id="view_details" 
                                                   data-talent="<?php echo $talent; ?>" data-approv="0"
                                                   data-date="<?php echo date('Y-m-d', strtotime($eachDays['date_of_od'])); ?>" >Timesheet
                                                </a>
                                            </td>
...
//Initialize Select2 Elements
    ...
    //below code commented because the hover data is now showing in the table
